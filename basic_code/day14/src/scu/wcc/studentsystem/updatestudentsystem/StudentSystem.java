...
public class StudentSystem {
    private final static String ADD_STUDENT = "1";
    private final static String DELETE_STUDENT = "2";
    private final static String UPDATE_STUDENT = "3";
    private final static String QUERY_STUDENT = "4";
    private final static String QUIT = "5";
