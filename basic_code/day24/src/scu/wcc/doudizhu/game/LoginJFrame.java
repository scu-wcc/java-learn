package scu.wcc.doudizhu.game;



import scu.wcc.doudizhu.domain.User;
import scu.wcc.doudizhu.util.CodeUtil;
...
public class LoginJFrame extends JFrame implements MouseListener {
    ...
    public void initView() {
        ...
        login.setIcon(new ImageIcon("basic_code/day24/image/login/登录按钮.png"));
        //去除按钮的边框
        ...
        register.setIcon(new ImageIcon("basic_code/day24/image/login/注册按钮.png"));
        //去除按钮的边框
        ...
        //7.添加背景图片
        JLabel background = new JLabel(new ImageIcon("basic_code/day24/image/login/background.png"));
    ...
    public void mousePressed(MouseEvent e) {
        if (e.getSource() == login) {
            login.setIcon(new ImageIcon("basic_code/day24/image/login/登录按下.png"));
        } else if (e.getSource() == register) {
            register.setIcon(new ImageIcon("basic_code/day24/image/login/注册按下.png"));
        }
    }
